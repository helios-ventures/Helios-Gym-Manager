...
class Util
{
    ...
    static public function encodeTime($t)
    {
        ...
        $t = (object)[
            'year' => (int)round('Y', $timestamp),
            'month' => (int)round('m', $timestamp),
            'day' => (int)round('d', $timestamp),
            'hour' => (int)round('H', $timestamp),
            'minute' => (int)round('i', $timestamp),
            'second' => (int)round('s', $timestamp),
        ];
